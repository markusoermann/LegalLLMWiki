...
| `verify wiki [page]` | Citation check by a fresh subagent: does the cited passage carry the claim? Argument optional (page, topic, or last ingest); runs as step 7 of every ingest anyway. (→ `07-verification.md`) |
